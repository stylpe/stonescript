...
function provideHover(document, position, token) {
	...
	let list = [
		...
		{ id: 'buffs.oldest', name: 'The ID of the oldest buff on the player'},
		...
		{ id: 'debuffs.oldest', name: 'The ID of the oldest debuff on the player'},
		...
		{ id: 'time.msbn', name: 'Unix time represents the number of milliseconds that have elapsed since 1970-01-01T00:00:00Z (January 1, 1970, at 12:00 AM UTC). It does not take leap seconds into account. Returns a BigNumber'},
		...
		// #endregion
		// #region Buffs
		{ id: 'berserk', name: 'Potion effect' },
		{ id: 'experience', name: 'Potion effect' },
		{ id: 'invisibility', name: 'Potion effect' },
		{ id: 'lucky_crit', name: 'Potion effect' },
		{ id: 'lucky_mult', name: 'Potion effect' },
		{ id: 'strength', name: 'Potion effect' },
		{ id: 'vampiric', name: 'Potion effect' },
		// New one
		{ id: 'bardiche_buff_aoe_chance', name: 'Effect' },
		{ id: 'bardiche_buff_crit_chance', name: 'Effect' },
		{ id: 'bardiche_buff_crit_mult', name: 'Effect' },
		{ id: 'bardiche_buff_move_speed', name: 'Effect' },
		{ id: 'bardiche_buff_move_speed', name: 'Effect' },
		{ id: 'shovel_damage', name: 'Effect' },
		{ id: 'bardiche_buff_move_speed', name: 'Effect' },
		{ id: 'quarterstaff_buff_attack_speed', name: 'Effect' },
		{ id: 'quarterstaff_buff_stun', name: 'Effect' },
		{ id: 'pick_pocket', name: 'Effect' },
		{ id: 'bardiche_buff_aoe_chance', name: 'Effect' },
		{ id: 'smite', name: 'Effect' },
		{ id: 'buff_staff_berserk', name: 'Effect' },
		{ id: 'buff_staff_protection', name: 'Effect' },
		{ id: 'buff_range', name: 'Effect' },
		{ id: 'buff_bullet_width', name: 'Effect' },
		{ id: 'buff_infernal', name: 'Effect' },
		{ id: 'buff_inf_speed', name: 'Effect' },
		{ id: 'buff_frozen', name: 'Effect' },
		{ id: 'buff_damage', name: 'Effect' },
		// Debuffs
		{ id: 'debuff_dot', name: 'Effect' },
		{ id: 'debuff_attack_speed', name: 'Effect' },
		{ id: 'debuff_yeti_chill', name: 'Effect' },
		{ id: 'debuff_chill', name: 'Effect' },
		{ id: 'debuff_move_speed', name: 'Effect' },
		{ id: 'puff_debuff_damage', name: 'Effect' },
		{ id: 'pallas_phase2_debuff', name: 'Effect' },
		{ id: 'stun', name: 'Effect' },
		{ id: 'spider_debuff_damage', name: 'Effect' },
		{ id: 'debuff_duration_damage', name: 'Effect' },
		{ id: 'debuff_damage', name: 'Effect' },
		{ id: 'dysangelos_debuff_damage', name: 'Effect' },
		// Darkness
		{ id: 'debuff_darkness_move_speed', name: 'Effect' },
		{ id: 'debuff_darkness_range', name: 'Effect' },
		{ id: 'debuff_darkness_accuracy', name: 'Effect' },
		// Eternity
		{ id: 'bardiche_buff_move_speed', name: 'Effect' },
		{ id: 'quarterstaff_buff_attack_speed', name: 'Effect' },
		{ id: 'debuff_weapon_swap_lock', name: 'Effect' },
		// #endregion
		// #region Debuffs
		{ id: 'spider_buff_damage', name: 'Debuff' },
		// Dysangelos
		{ id: 'adaptive_defense_poison', name: 'Dysangelos debuff effect' },
		{ id: 'adaptive_defense_vigor', name: 'Dysangelos debuff effect' },
		{ id: 'adaptive_defense_aether', name: 'Dysangelos debuff effect' },
		{ id: 'adaptive_defense_fire', name: 'Dysangelos debuff effect' },
		{ id: 'adaptive_defense_ice', name: 'Dysangelos debuff effect' },
		{ id: 'buff_protection', name: 'Dysangelos debuff effect' },
		{ id: 'poena_mirror', name: 'Dysangelos debuff effect' },
		{ id: 'poena_crit', name: 'Dysangelos debuff effect' },
		{ id: 'poena_mult', name: 'Dysangelos debuff effect' },
		// Eliete
		{ id: 'stability', name: 'Eliete buff effect' },
		{ id: 'stoic', name: 'Eliete buff effect' },
		{ id: 'immortal', name: 'Eliete buff effect' },
		{ id: 'buff_tenacious', name: 'Eliete buff effect' },
		{ id: 'buff_rebirth', name: 'Eliete buff effect' },
		{ id: 'buff_mirror', name: 'Eliete buff effect' },
		// Items
		{ id: 'debuff_frost_stun', name: 'Item debuff effect' },
		{ id: 'debuff_armor_fatigue', name: 'Item debuff effect' },
		{ id: 'debuff_dot', name: 'Item debuff effect' },
		{ id: 'debuff_dot2', name: 'Item debuff effect' },
		{ id: 'debuff_chill', name: 'Item debuff effect' },
		{ id: 'debuff_feeble', name: 'Item debuff effect' },
		{ id: 'ignition', name: 'Item debuff effect' },
		{ id: 'stun', name: 'Item debuff effect' },
		{ id: 'unstable', name: 'Item debuff effect' },
		{ id: 'debuff_damage', name: 'Item debuff effect' },
		// #endregion
